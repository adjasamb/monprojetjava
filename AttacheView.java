...
public class AttacheView {
    public static void main(String[] args) throws Exception {
        ...
        do{
            System.out.println("1-Creer des inscriptions ou reinscriptions");
            System.out.println("2-Lister les étudiants inscrits");
            System.out.println("3-Lister les étudiants dans une classe");
            ...
            switch (choix) {
                ...
                etudiant= etudiantService.rechercherEtudianttParMatricule(matricule);
                if (etudiant==null) {
                ...
                List<Inscription> inscriptions=inscriptionService.listerInscriptionParanneescolaire1(anneeScolaire);
                ...
                if(reponse.equalsIgnoreCase("oui")){
                    ...
                    inscriptions= inscriptionService.listerInscriptionParanneescolaire2(anneeScolaire,idClasse);
                    for (Inscription inscript : inscriptions) {
                        System.out.println("Matricule: "+inscript.getEtudiant().getMatricule()+"\n Nom complet : "+inscript.getEtudiant().getNomComplet()+"\n Tuteur : "+inscript.getEtudiant().getNomComplet());
                ...
                List<Etudiant> etudiants=etudiantService.listerEtudiant();
                 for (Etudiant et:etudiants){
                    System.out.println("NomComplet :"+et.getId());
                    System.out.println("NomComplet :"+et.getNomComplet());
                    System.out.println("NomComplet :"+et.getMatricule());
                    System.out.println("NomComplet :"+et.getClass());
                    System.out.println("===============================");
                 }
                    break;
